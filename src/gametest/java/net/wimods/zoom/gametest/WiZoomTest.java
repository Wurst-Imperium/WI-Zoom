...
public final class WiZoomTest implements FabricClientGameTest
{
	...
	{
		if(context
			.computeOnClient(mc -> mc.player.getInventory().selectedSlot) != 0)
